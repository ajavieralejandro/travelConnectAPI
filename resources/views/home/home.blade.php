...
<body>
    ...
    <header class="py-4 text-center ">
        <nav class="relative flex items-center justify-between px-4 py-4 bg-white">
            ...
            <a class="hidden px-6 py-2 text-sm font-bold text-gray-900 transition duration-200 lg:inline-block lg:ml-auto lg:mr-3 bg-gray-50 hover:bg-gray-100 rounded-xl" href="#">Sign In</a>
            <a class="hidden px-6 py-2 text-sm font-bold text-white transition duration-200 bg-blue-500 lg:inline-block hover:bg-blue-600 rounded-xl" href="#">Sign up</a>
        </nav>
            ...
            <nav class="fixed top-0 bottom-0 left-0 flex flex-col w-5/6 max-w-sm px-6 py-6 overflow-y-auto bg-white border-r">
                ...
                <div class="mt-auto">
                    <div class="pt-6">
                        ...
                        <a class="block px-4 py-3 mb-2 text-xs font-semibold leading-loose text-center text-white bg-blue-600 hover:bg-blue-700 rounded-xl" href="#">Sign Up</a>
                    </div>
    ...
    <main>
        ...
        <section class="text-black welcome-section position-relative">
            ...
            <div class="container py-5 text-center">
                ...
                @if (isset($textoBienvenida) && isset($textoBienvenida->contenido) && !empty($textoBienvenida->contenido))
                    <p class="mt-3 animate-text lead">
        ...
        <section style="display: flex; justify-content: center; padding: 40px; ">
            <div style="display: flex; gap: 40px; max-width: 1200px; width: 100%;">
                <!-- Columna 1 -->
                <div
                    style="flex: 1; padding: 20px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
    ...
    <footer class="footer">
        ...
        <div class="text-center row contact-info">
            <div class="col-12">
                <p><i class="mr-2 fas fa-phone"></i> (11) 5578 6993</p>
            </div>
        </div>
